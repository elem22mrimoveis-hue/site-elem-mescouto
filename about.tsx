      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-6 lg:grid-cols-2 lg:gap-20">
        ...
        <div>
          ...
          <div className="mt-6 space-y-4 text-pretty leading-relaxed text-muted-foreground">
            ...
            <p>
              Minha trajetória foi construída pela superação, pela busca contínua
              por conhecimento e pela convicção de que pessoas desenvolvidas
              transformam organizações e sociedades.
            </p>
            <p>
              Ao longo da minha caminhada, atuei no empreendedorismo, na educação
              superior, na formação de profissionais e no desenvolvimento de
              líderes, conectando estratégia, aprendizagem e crescimento humano.
            </p>
            <p>
